...
def cnn_model():
    ...
    c_train = pathpath + 'train_healthy_gender.tfrecords'
    c_test = pathpath + 'test_healthy_gender.tfrecords'
    ...
    hc_test_img, hc_test_label = tf.train.shuffle_batch([hc_im_, hc_lab_],
                                            batch_size = 15, capacity = hc_test_num,
                                            min_after_dequeue = 10)
